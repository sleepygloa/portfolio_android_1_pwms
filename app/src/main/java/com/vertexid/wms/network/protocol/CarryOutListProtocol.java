 ...
 * 반출목록 요청 프로토콜 생성
 */
public class CarryOutListProtocol {
    private CarryOutInfo mInfo = null;

    public CarryOutListProtocol(CarryOutInfo info) {
        mInfo = info;
    }

    /**
     * 반출목록 요청을 처리하는 WAS 메소드 반환
     * @return 반출목록 요청을 처리하는 WAS 메소드
     */
    public String getReqMethod() {
        return "/ctrl/returnoutbound/returnoutboundPickingPda/listReturnOutboundPickingPda";
    }
