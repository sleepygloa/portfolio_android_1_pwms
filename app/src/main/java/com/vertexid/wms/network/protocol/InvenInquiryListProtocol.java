 ...
 * 재고조사 목록 요청 프로토콜 생성
 */
public class InvenInquiryListProtocol {
    private InvenInquiryInfo mInfo = null;

    public InvenInquiryListProtocol(InvenInquiryInfo info) {
        mInfo = info;
    }

    /**
     * 재고조사 목록 요청을 처리하는 WAS 메소드 반환
     * @return 재고조사 목록 요청을 처리하는 WAS 메소드
     */
    public String getReqMethod() {
        return "/ctrl/stock/stockInspPda/listStockInspPda";
    }
