...
/**
 * 반입 적치 제품 목록 요청 프로토콜 생성
 */
public class CarryInPileUpGoodsListProtocol {
    private CarryInInfo mInfo = null;

    public CarryInPileUpGoodsListProtocol(CarryInInfo info) {
        mInfo = info;
    }

    /**
     * 반입 적치 제품 목록 요청을 처리하는 WAS 메소드 반환
     * @return 반입 적치 제품 목록 요청을 처리하는 WAS 메소드
     */
    public String getReqMethod() {
        return "/ctrl/returninbound/returninboundPutwPda/listReturnInboundPutwItemPda";
    }

    /**
     * 반입 적치 제품 목록 요청 내용 반환
     * @return JSON 형식의 문자열.
     */
