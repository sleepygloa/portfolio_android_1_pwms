...
/**
 * 재고조사 신규 제품 조회 요청 프로토콜 생성
 */
public class InvenCreateSearchProtocol {
    private InvenInquiryInfo mInfo = null;

    public InvenCreateSearchProtocol(InvenInquiryInfo info) {
        mInfo = info;
    }

    /**
     * 재고조사 신규 제품 조회 요청을 처리하는 WAS 메소드 반환
     * @return 재고조사 신규 제품 조회 요청을 처리하는 WAS 메소드
     */
    public String getReqMethod() {
        return "/ctrl/stock/stockInspPda/getItemPda";
    }

    /**
     * 재고조사 신규 제품 조회 요청 내용 반환
     * @return JSON 형식의 문자열.
     */
