 ...
 * 제품 목록을 요청하는 프로토콜 생성
 */
public class GoodsInquiryProtocol {
    private InquiryInfo mInfo = null;

    public GoodsInquiryProtocol(InquiryInfo info) {
        mInfo = info;
    }

    /**
     * 제품 목록 요청을 처리하는 WAS 메소드 반환
     * @return 제품 목록 요청을 처리하는 WAS 메소드
     */
    public String getReqMethod() {
        return "/ctrl/stock/stockItemSearchPda/listStockItemSearchPda";
    }
