 ...
 * 출고번호 조회 요청 프로토콜
 */
public class TakeOutNumberProtocol {
    private TakeOutInfo mInfo = null;

    public TakeOutNumberProtocol(TakeOutInfo info) {
        mInfo = info;
    }
    ...
    public String getReqMethod() {
        return "/ctrl/outbound/outboundPickingPda/listOutboundNoPda";
    }
    ...
    public String getReqPayload() {
        ...
        try {
            ...
            object.put(NetworkParam.TAKE_OUT_DATE, mInfo.getTakeoutDate());
            object.put(NetworkParam.TAKE_OUT_CATEGORY, mInfo.getTakeOutCategory());
