 ...
 * 출고목록 조회 요청 프로토콜
 */
public class TakeOutLoadingListProtocol {
    private TakeOutInfo mInfo = null;

    public TakeOutLoadingListProtocol(TakeOutInfo info) {
        mInfo = info;
    }
    ...
    public String getReqMethod() {
        return "/ctrl/outbound/outboundCarLoadingPda/listOutboundCarLoadingPda";
    }
    ...
    public String getReqPayload() {
        ...
        try {
            ...
            object.put(NetworkParam.CAR_NUMBER, mInfo.getCarNum());
