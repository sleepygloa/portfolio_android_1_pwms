...
/**
 * 입고 시리얼 스캔 목록 요청 프로토콜 생성
 */
public class WareSerialScanProtocol {
    private SerialScanInfo mInfo = null;

    public WareSerialScanProtocol(SerialScanInfo info) {
        mInfo = info;
    }

    /**
     * 입고 시리얼 스캔 목록 요청을 처리하는 WAS 메소드 반환
     * @return 입고 시리얼 스캔 목록 요청을 처리하는 WAS 메소드
     */
    public String getReqMethod() {
        return "/ctrl/inbound/inboundSerialPda/listInboundSerialPda";
    }

    /**
     * 입고 시리얼 스캔 목록 요청 내용 반환
     * @return JSON 형식의 문자열.
     */
    public String getReqPayload() {
        ...
        try {
            ...
            object.put(NetworkParam.WAREHOUSE_NUMBER, mInfo.getNumber());
