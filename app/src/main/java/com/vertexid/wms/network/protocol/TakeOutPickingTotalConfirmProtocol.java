...
/**
 * 출고(총량)피킹확정 요청 프로토콜 생성
 */
public class TakeOutPickingTotalConfirmProtocol {
    private TakeOutInfo mInfo = null;

    public TakeOutPickingTotalConfirmProtocol(TakeOutInfo info) {
        mInfo = info;
    }
    ...
    public String getReqMethod() {
        return "/ctrl/outbound/outboundPickingPda/updateObConfirmPickingTotalPda";
    }
