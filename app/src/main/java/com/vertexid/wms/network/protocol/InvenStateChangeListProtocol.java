...
/**
 * 재고상태 변경 목록 요청 프로토콜 생성
 */
public class InvenStateChangeListProtocol {
    private InventoryStateChangeInfo mInfo = null;

    public InvenStateChangeListProtocol(InventoryStateChangeInfo info) {
        mInfo = info;
    }

    /**
     * 재고상태 변경 목록 요청을 처리하는 WAS 메소드 반환
     * @return 재고상태 변경 목록 요청을 처리하는 WAS 메소드
     */
    public String getReqMethod() {
        return "/ctrl/stock/stockStateChangePda/listStockStateChangePda";
    }
