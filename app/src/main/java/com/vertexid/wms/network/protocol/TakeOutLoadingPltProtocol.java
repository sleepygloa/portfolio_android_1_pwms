...
/**
 * 출하상차리스트 상세 파렛트 목록 조회 요청 프로토콜
 */
public class TakeOutLoadingPltProtocol {
    private TakeOutLoadingInfo mInfo = null;

    public TakeOutLoadingPltProtocol(TakeOutLoadingInfo info) {
        mInfo = info;
    }

    /**
     * 출하상차리스트 상세 파렛트 목록 요청을 처리하는 WAS 메소드 반환
     * @return 출하상차리스트 상세 파렛트 목록 요청을 처리하는 WAS 메소드
     */
    public String getReqMethod() {
        return "/ctrl/outbound/outboundCarLoadingPda/listOutboundCarLoadingPltPda";
    }
    ...
    public String getReqPayload() {
        ...
        try {
            ...
            object.put(NetworkParam.TAKE_OUT_DETAIL_NUMBER, mInfo.getDetailNumber());
