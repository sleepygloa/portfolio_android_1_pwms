...
public class SearchActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        NavigationView navi_view = (NavigationView) findViewById(R.id.search_navi_view);
        ...
        TextView text_user = (TextView) findViewById(R.id.search_text_user);
        text_user.setText(user_id + "(" + center.getText() + "/" + customer.getText() + ")");

        FrameLayout layout_title_menu = (FrameLayout) findViewById(R.id.search_layout_btn_menu);
        layout_title_menu.setOnClickListener(mClickListener);

        LinearLayout btn_goods_inquiry = (LinearLayout) findViewById(R.id.search_layout_goods_inquiry);
        btn_goods_inquiry.setOnClickListener(mClickListener);
        LinearLayout btn_loc_inquiry = (LinearLayout) findViewById(R.id.search_layout_loc_inquiry);
        btn_loc_inquiry.setOnClickListener(mClickListener);
    }
    ...
    private View.OnClickListener mClickListener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            int id = v.getId();
            if (id == R.id.search_layout_btn_menu) {
                mDrawerLayout.openDrawer(GravityCompat.START);
            }
            else if (id == R.id.search_layout_goods_inquiry) {
                moveNextActivity(GoodsInquiryActivity.class);
            }
            else if (id == R.id.search_layout_loc_inquiry) {
                moveNextActivity(LocInquiryActivity.class);
            }
        }
    };
