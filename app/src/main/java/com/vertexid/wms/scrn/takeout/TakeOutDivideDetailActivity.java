...
import com.vertexid.wms.scrn.takeout.adapter.TakeOutDivideDetailItemAdapter;
 ...
 * 출고분배상세화면
 */
public class TakeOutDivideDetailActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.take_out_distribution_list_activity);

        mContext = this;

        Intent intent = getIntent();
        if (intent != null) {
            mArray = (ArrayList<TakeOutInfo>) intent.getSerializableExtra(ScrnParam.INFO_LIST);
        }
        ...
        mDrawerLayout = (DrawerLayout) findViewById(R.id.take_out_distribution_list_drawer);
        NavigationView navi_view = (NavigationView) findViewById(R.id.take_out_distribution_list_navi_view);
        ...
        TextView text_user = (TextView) findViewById(R.id.take_out_distribution_list_text_user);
        ...
        mEditGoodsCode = (EditText) findViewById(R.id.take_out_distribution_list_edit_goods_code);
        mEditGoodsName = (EditText) findViewById(R.id.take_out_distribution_list_edit_goods_name);

        TextView text_total_count = (TextView) findViewById(R.id.take_out_distribution_list_text_total_count);
        text_total_count.setText("총 " + String.valueOf(mArray.size()) + "건");

        TakeOutDivideDetailItemAdapter adapter = new TakeOutDivideDetailItemAdapter(mContext, mArray);
        ListView list_view = (ListView) findViewById(R.id.take_out_distribution_list_listview);
    ...
    private void showListInfo(int position) {
        TakeOutInfo info = mArray.get(position);

        mEditGoodsCode.setText(info.getGoods());
        mEditGoodsName.setText(info.getGoodsName());
    }
