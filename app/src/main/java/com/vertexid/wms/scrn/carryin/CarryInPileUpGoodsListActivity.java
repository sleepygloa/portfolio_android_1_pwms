...
import com.vertexid.wms.scrn.carryin.adapter.CarryInPileUpGoodsItemAdapter;
 ...
 * 적치 대상 제품 목록
 */
public class CarryInPileUpGoodsListActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.carry_in_pile_goods_list_activity);

        mContext = this;

        mDrawerLayout = (DrawerLayout) findViewById(R.id.carry_in_pile_goods_list_drawer);
        NavigationView navi_view = (NavigationView) findViewById(R.id.carry_in_pile_up_goods_list_navi_view);
        ...
        TextView text_user = (TextView) findViewById(R.id.carry_in_pile_up_goods_list_text_user);
        text_user.setText(user_id + "(" + center.getText() + "/" + customer.getText() + ")");

        Button btn_menu = (Button) findViewById(R.id.carry_in_pile_up_goods_list_btn_menu);
        btn_menu.setOnClickListener(mClickListener);

        Intent intent = getIntent();
        if (intent != null) {
            mArray = (ArrayList<CarryInInfo>) intent.getSerializableExtra(ScrnParam.INFO_LIST);
        }
        ...
        TextView text_total_count = (TextView) findViewById(R.id.carry_in_pile_up_goods_list_text_total_count);
        text_total_count.setText("총 " + mArray.size() + "건");

        CarryInPileUpGoodsItemAdapter adapter = new CarryInPileUpGoodsItemAdapter(mContext, mArray);
        ListView list = (ListView) findViewById(R.id.carry_in_pile_up_goods_list_list);
    ...
    private void moveNextActivity(int position) {
        ...
        Intent i = new Intent();
        i.setClass(mContext, CarryInPileUpActivity.class);
