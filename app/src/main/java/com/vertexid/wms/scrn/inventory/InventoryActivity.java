...
public class InventoryActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDrawerLayout = (DrawerLayout) findViewById(R.id.inventory_drawer);
        NavigationView navi_view = (NavigationView) findViewById(R.id.inventory_navi_view);
        ...
        TextView text_user = (TextView) findViewById(R.id.inventory_text_user);
        text_user.setText(user_id + "(" + center.getText() + "/" + customer.getText() + ")");

        FrameLayout btn_menu = (FrameLayout) findViewById(R.id.inventory_layout_btn_menu);
        btn_menu.setOnClickListener(mClickListener);

        LinearLayout btn_move = (LinearLayout) findViewById(R.id.inventory_layout_move);
        btn_move.setOnClickListener(mClickListener);
        LinearLayout btn_temp_move = (LinearLayout) findViewById(R.id.inventory_layout_temp_move);
        btn_temp_move.setOnClickListener(mClickListener);
        LinearLayout btn_inquiry = (LinearLayout) findViewById(R.id.inventory_layout_inquiry);
        btn_inquiry.setOnClickListener(mClickListener);
        LinearLayout btn_state_change = (LinearLayout) findViewById(R.id.inventory_layout_state_change);
        btn_state_change.setOnClickListener(mClickListener);
        LinearLayout btn_plt_divide = (LinearLayout) findViewById(R.id.inventory_layout_plt_divide);
        btn_plt_divide.setOnClickListener(mClickListener);
        LinearLayout btn_plt_merge = (LinearLayout) findViewById(R.id.inventory_layout_plt_merge);
        btn_plt_merge.setOnClickListener(mClickListener);
    }
    ...
    private View.OnClickListener mClickListener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            int id = v.getId();
            if (id == R.id.inventory_layout_btn_menu) {
                mDrawerLayout.openDrawer(GravityCompat.START);
            }
            else if (id == R.id.inventory_layout_move) {
                moveNextActivity(InventoryMoveActivity.class);
            }
            else if (id == R.id.inventory_layout_temp_move) {
                moveNextActivity(InventoryTempMoveActivity.class);
            }
            else if (id == R.id.inventory_layout_inquiry) {
                moveNextActivity(InventoryInquiryActivity.class);
            }
            else if (id == R.id.inventory_layout_state_change) {
                moveNextActivity(InventoryStateChangeActivity.class);
            }
            else if (id == R.id.inventory_layout_plt_divide) {
                moveNextActivity(InventoryPltDivideActivity.class);
            }
            else if (id == R.id.inventory_layout_plt_merge) {
                moveNextActivity(InventoryPltMergeActivity.class);
            }
        }
    };
