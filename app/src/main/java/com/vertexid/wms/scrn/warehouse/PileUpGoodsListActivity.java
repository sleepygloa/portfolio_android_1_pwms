...
import com.vertexid.wms.scrn.warehouse.adapter.PileUpGoodsItemAdapter;
 ...
 * 적치 제품 목록 화면
 */
public class PileUpGoodsListActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.ware_pile_goods_list_activity);

        mContext = this;

        mDrawerLayout = (DrawerLayout) findViewById(R.id.ware_pile_goods_list_drawer);
        NavigationView navi_view = (NavigationView) findViewById(R.id.ware_pile_up_goods_list_navi_view);
        ...
        TextView text_user = (TextView) findViewById(R.id.ware_pile_up_goods_list_text_user);
        text_user.setText(user_id + "(" + center.getText() + "/" + customer.getText() + ")");

        Button btn_menu = (Button) findViewById(R.id.ware_pile_up_goods_list_btn_menu);
        btn_menu.setOnClickListener(mClickListener);

        Intent intent = getIntent();
        if (intent != null) {
            mArray = (ArrayList<WareHouseInfo>) intent.getSerializableExtra(ScrnParam.INFO_LIST);
        }
        ...
        TextView text_total_count = (TextView) findViewById(R.id.ware_pile_up_goods_list_text_total_count);
        text_total_count.setText("총 " + mArray.size() + "건");

        PileUpGoodsItemAdapter adapter = new PileUpGoodsItemAdapter(mContext, mArray);
        ListView list_view = (ListView) findViewById(R.id.ware_pile_up_goods_list_list);
    ...
    private void moveNextActivity(int position) {
        ...
        Intent i = new Intent();
        i.setClass(mContext, PileUpActivity.class);
        i.putExtra(ScrnParam.INFO_DETAIL, info);
    ...
    private View.OnClickListener mClickListener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            int id = v.getId();
            if (id == R.id.ware_pile_up_goods_list_btn_menu) {
