...
import com.vertexid.wms.scrn.inventory.adapter.TempMoveItemAdapter;
 ...
 * 임의재고 LOC 조회
 */
public class InventoryTempMoveLocActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.inventory_temp_move_loc_activity);

        mContext = this;

        mDrawerLayout = (DrawerLayout) findViewById(R.id.inventory_temp_move_loc_drawer);
        NavigationView navi_view = (NavigationView) findViewById(R.id.inventory_temp_move_loc_navi_view);
        ...
        TextView text_user = (TextView) findViewById(R.id.inventory_temp_move_loc_text_user);
        text_user.setText(user_id + "(" + center.getText() + "/" + customer.getText() + ")");

        FrameLayout btn_menu = (FrameLayout) findViewById(R.id.inventory_temp_move_loc_layout_btn_menu);
        btn_menu.setOnClickListener(mClickListener);

        Intent intent = getIntent();
        if (intent != null) {
            mArray = (ArrayList<InvenMoveInfo>) intent.getSerializableExtra(ScrnParam.INFO_LIST);
        }
        ...
        TextView text_total_count = (TextView) findViewById(R.id.inventory_temp_move_loc_text_total_count);
        text_total_count.setText("총 " + mArray.size() + "건");

        TempMoveItemAdapter adapter = new TempMoveItemAdapter(mContext, mArray);
        ListView list_view = (ListView) findViewById(R.id.inventory_temp_move_loc_list);
    ...
    private void moveNextActivity(int position) {
        ...
        Intent i = new Intent();
        i.setClass(mContext, InventoryTempMoveActivity.class);
