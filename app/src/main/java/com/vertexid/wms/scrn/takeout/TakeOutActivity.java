...
public class TakeOutActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDrawerLayout = (DrawerLayout) findViewById(R.id.take_out_drawer);
        NavigationView navi_view = (NavigationView) findViewById(R.id.take_out_navi_view);
        ...
        TextView text_user = (TextView) findViewById(R.id.take_out_text_user);
        text_user.setText(user_id + "(" + center.getText() + "/" + customer.getText() + ")");

        Button btn_menu = (Button) findViewById(R.id.take_out_btn_menu);
        btn_menu.setOnClickListener(mClickListener);
        LinearLayout layout_picking = (LinearLayout) findViewById(R.id.take_out_layout_picking);
        layout_picking.setOnClickListener(mClickListener);
        LinearLayout layout_serial_scan = (LinearLayout) findViewById(R.id.take_out_layout_serial_scan);
        layout_serial_scan.setOnClickListener(mClickListener);
        LinearLayout layout_picking_total = (LinearLayout) findViewById(R.id.take_out_layout_picking_total);
        layout_picking_total.setOnClickListener(mClickListener);
        LinearLayout layout_distribution = (LinearLayout) findViewById(R.id.take_out_layout_distribution);
        layout_distribution.setOnClickListener(mClickListener);
        LinearLayout layout_loading = (LinearLayout) findViewById(R.id.take_out_layout_loading);
        layout_loading.setOnClickListener(mClickListener);
    ...
    private View.OnClickListener mClickListener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            int id = v.getId();
            if (id == R.id.take_out_btn_menu) {
                mDrawerLayout.openDrawer(GravityCompat.START);
            }
            else if(id == R.id.take_out_layout_picking){
                moveNextActivity(TakeOutListActivity.class);
            }
            else if(id == R.id.take_out_layout_serial_scan){
                moveNextActivity(TakeOutSerialScanActivity.class);
            }
            else if(id == R.id.take_out_layout_picking_total){
                moveNextActivity(TakeOutPickingTotalActivity.class);
            }
            else if(id == R.id.take_out_layout_distribution){
                moveNextActivity(TakeOutDistributionActivity.class);
            }
            else if(id == R.id.take_out_layout_loading){
                moveNextActivity(TakeOutLoadingActivity.class);
            }
        }
    };
