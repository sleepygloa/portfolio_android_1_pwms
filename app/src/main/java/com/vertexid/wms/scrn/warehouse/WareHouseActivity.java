...
public class WareHouseActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDrawerLayout = (DrawerLayout) findViewById(R.id.warehouse_drawer);
        NavigationView navi_view = (NavigationView) findViewById(R.id.warehouse_navi_view);
        ...
        TextView text_user = (TextView) findViewById(R.id.warehouse_text_user);
        text_user.setText(user_id + "(" + center.getText() + "/" + customer.getText() + ")");

        FrameLayout btn_menu = (FrameLayout) findViewById(R.id.warehouse_layout_btn_menu);
        btn_menu.setOnClickListener(mClickListener);

        LinearLayout btn_arrival_check = (LinearLayout) findViewById(R.id.warehouse_layout_arrive_check);
        btn_arrival_check.setOnClickListener(mClickListener);
        LinearLayout btn_pile_up = (LinearLayout) findViewById(R.id.warehouse_layout_pile_up);
        btn_pile_up.setOnClickListener(mClickListener);
        LinearLayout btn_serial_scan = (LinearLayout) findViewById(R.id.warehouse_layout_serial_scan);
        btn_serial_scan.setOnClickListener(mClickListener);
    }
    ...
    private void reqLogOut() {
        ...
        showProgress(true, mContext.getText(R.string.progress_logout).toString());
    ...
    private View.OnClickListener mClickListener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            int id = v.getId();
            if (id == R.id.warehouse_layout_btn_menu) {
                mDrawerLayout.openDrawer(GravityCompat.START);
            }
            else if (id == R.id.warehouse_layout_arrive_check) {
                moveNextActivity(ArrivalCheckActivity.class);
            }
            else if (id == R.id.warehouse_layout_pile_up) {
                moveNextActivity(PileUpActivity.class);
            }
            else if (id == R.id.warehouse_layout_serial_scan) {
                moveNextActivity(SerialScanActivity.class);
            }
        }
    };
